<h1 align="center">
  <br>
  <!-- image/logo link -->
  <a href="https://mitchellmunderwood.github.io/Team-Generator-CLI/"><img src="./README-support/logo.png" alt="title" width="200" height="200" ></a>
...
Create and manage your team in the CLI.
</h4>
...
Team Generator CLI is currently deployed with Deployment. <a href="">Go to Live</a>.
<br/> -->
...
Team Generator CLI is licensed under the terms of the [MIT License](https://opensource.org/licenses/MIT) and is available for free.
...
Fork the repo, run `npm install` and then `node app.js`.

<br/>

### Usage

Usage of the CLI application is demonstrated in a tutorial video. <a href="https://mitchellmunderwood.github.io/Team-Generator-CLI/">Go to Video</a>.
